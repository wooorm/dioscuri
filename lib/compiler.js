 ...
 * @property {boolean | null | undefined} [allowDangerousProtocol=false]
 ...
 * @property {'\n' | '\r\n' | null | undefined} [defaultLineEnding]
 ...
 *   Configuration (optional).
 * @returns
 *   Function that compiles tokens to HTML.
 */
export function compiler(options) {
  const settings = options || {}
  let {defaultLineEnding} = settings
  const {allowDangerousProtocol} = settings
