 ...
 * @returns {Array<GtastNode>|GtastNode|string|void}
 */
 ...
 * @param {Context} context
 * @returns {Array.<GtastHeading|GtastText|GtastLink>|undefined}
 */
  ...
  while (++index < children.length) {
    ...
    if (value) {
      if (Array.isArray(value)) {
        // `Array.isArray(unknown)` casts to `any[]`.
